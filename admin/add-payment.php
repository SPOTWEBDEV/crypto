                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Admin /</span> Add Payment
                        </h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <?php
                                        if (isset($_POST['addPaymentAccount'])) {
                                            ...
                                            $bank_name = $account_name = $routing_number = $wallet_provider = $wu_name = null;
                                ...
                                VALUES ('$payment_type', '$account_number', '$bank_name', '$account_name', '$routing_number', '$wallet_provider')";
                                                ...
                                                if (mysqli_query($connection, $insertQuery)) {
                                                    ...
                                                    echo "<script>Swal.fire('Error','Error adding payment account','error')</script>";
                                                }
                                            } else {
                                                echo "<script>Swal.fire('Input Error','Please fill in all the required fields','error')</script>";
                                            }
                                        }
                                        ?>
                                        <form method="POST">
                                            ...
                                            <div id="bankFields" style="display: none;">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Bank of America" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="account_name">Account Name</label>
                                                    <input type="text" class="form-control" name="account_name" id="account_name" placeholder="John Doe" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="routing_number">Routing Number</label>
                                                    <input type="text" class="form-control" name="routing_number" id="routing_number" placeholder="987654321" />
                                                </div>
                                            </div>
                                            ...
                                            <div id="walletFields" style="display: none;">
                                                <div class="mb-3">
                                                    <label class="form-label" for="wallet_provider">Wallet Provider</label>
                                                    <input type="text" class="form-control" name="wallet_provider" id="wallet_provider" placeholder="PayPal" />
                                                </div>
                                            </div>

                                            <!-- Western Union Fields -->
                                            <div id="wuFields" style="display: none;">
                                                <div class="mb-3">
                                                    <label class="form-label" for="wu_name">Western Union Name</label>
                                                    <input type="text" class="form-control" name="wu_name" id="wu_name" placeholder="John Doe" />
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label" for="account_number">Account Number</label>
                                                <input type="text" class="form-control" name="account_number" id="account_number" placeholder="123456789" required />
                                            </div>

                                            <button type="submit" class="btn btn-primary" name="addPaymentAccount">Add Payment Account</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
