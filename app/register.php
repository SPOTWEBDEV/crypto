        ...
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                ...
                <div class="card custom-card">
                    <form action="./controllers/createUser.php" method="POST" class="card-body p-5">
                        <p class="h5 fw-semibold mb-2 text-center">Hello Dear</p>
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Sign Up</p>
                        <div class="row gy-3">
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">User Name</label>
                                <input type="text" name="user" class="form-control form-control-lg" id="signin-username" placeholder="@psycho">
                            </div>
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">Full Name</label>
                                <input type="text" name="name" class="form-control form-control-lg" id="signin-username" placeholder="John Doe">
                            </div>
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">Country</label>
                                <!--<input type="text" name="country" class="form-control form-control-lg" id="signin-username" placeholder="Egypt">-->
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                            ...
                            <div class="col-xl-12">
                                ...
                                <input type="email" name="email" class="form-control form-control-lg" id="signin-username" placeholder="johndoe@gmail.com">
                            </div>
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">Phone Number</label>
                                <input type="tel" name="phone" class="form-control form-control-lg" id="signin-username" placeholder="+44(584) 4859 4389">
                            </div>

                            <div class="col-xl-12 mb-2">
                                <label for="signin-username" class="form-label text-default">Password</label>
                                <div class="input-group">
                                    <input type="password" name="pass" class="form-control form-control-lg" id="signin-password1" placeholder="password">
                                    <button class="btn btn-light" type="button" onclick="createpassword('signin-password1',this)" id="button-addon2">
                                        <i class="ri-eye-off-line align-middle"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-2">
                                <label for="signin-username" class="form-label text-default">Repeat Password</label>
                                <div class="input-group">
                                    <input type="password" name="rp_pass" class="form-control form-control-lg" id="signin-password2" placeholder="password">
                                    <button class="btn btn-light" type="button" onclick="createpassword('signin-password2',this)" id="button-addon2">
                                        <i class="ri-eye-off-line align-middle"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <label for="signin-username" class="form-label text-default">Referral</label>
                        ...
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-3">Already have an account? <a href="login.php" class="text-primary">Log In</a></p>
                        </div>
                    </form>
                </div>
            </div>
