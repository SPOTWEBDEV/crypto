        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">TRADE HISTORY</h1>
                        ...
                        <table class="table text-nowrap table-borderless">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">RISK TO REWARD</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success-transparent">$<?php echo formatNumber($trade['amount']); ?></span></td>
                                            <td style="text-transform: capitalize;"><?php echo htmlspecialchars($trade['order_type']); ?></td>
                                            <td><?php echo $trade['stop_loss'] ?  htmlspecialchars($trade['stop_loss']) : 'N/A'; ?></td>
