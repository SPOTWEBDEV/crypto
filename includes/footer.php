                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text-two text-center">
                            <p>Copyright © <?php echo $sitename ?> | All Right Reserved</p>
                        </div>
                        <div class="copyright-text-two d-flex justify-content-end">
                            <a href="https://mywebsite-firstclass.vercel.app/">Develop By SPOTWEBDEV COMPANY</a>
                        </div>
                    </div>
                </div>
            </div>
